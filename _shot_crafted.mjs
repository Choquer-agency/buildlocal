...
const port=9351;
const prof='/tmp/cr-crafted-'+port;
...
try{
  await shoot('http://localhost:4500/p/crafted-outdoor-living','/tmp/crafted_hero.png',1000);
  await shoot('http://localhost:4500/p/crafted-outdoor-living/services','/tmp/crafted_svc.png',2200);
