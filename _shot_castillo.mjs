...
const port=9377;
const prof='/tmp/cr-castillo-'+port;
...
try{
  await shoot('http://localhost:4500/p/castillo-landscaping','/tmp/castillo_hero.png',1000);
  await shoot('http://localhost:4500/p/castillo-landscaping/services','/tmp/castillo_svc.png',2400);
