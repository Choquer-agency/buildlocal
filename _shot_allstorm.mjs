...
await send('Page.navigate',{url:'http://localhost:4500/p/all-storm-roofing-and-construction'});
await wait(4000);
...
fs.writeFileSync('_shots/allstorm_hero.png',Buffer.from(shot.result.data,'base64'));
console.log('done');
