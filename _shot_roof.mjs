...
await send('Page.navigate',{url:'http://localhost:4500/p/arizona-roofing-and-restoration/services'});
await wait(4500);
...
fs.writeFileSync('_shots/roof-services.png',Buffer.from(shot.result.data,'base64'));
console.log('shot saved', fs.statSync('_shots/roof-services.png').size,'bytes');
